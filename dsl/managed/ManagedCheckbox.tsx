...
export class ManagedCheckbox extends Widget<ManagedCheckbox, Properties, Configuration> {
    ...
    onCheck = (action: Dispatch<boolean>) => this.useChecked(checked => checked.consume(action));
...
export const checkbox = (properties?: Properties) => new ManagedCheckbox(properties, Configuration);
